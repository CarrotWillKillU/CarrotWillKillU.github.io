...
$paypalConfig = array(
  ...
  "environment" => $config['merchant']['paypal_testing'] ? "sandbox" : "live", // sandbox or live
  "user"  => $config['merchant']['paypal_user'],
  "pwd"  => $config['merchant']['paypal_password'],
  "signature"  => $config['merchant']['paypal_signature'],
  "version"  => 113
);
